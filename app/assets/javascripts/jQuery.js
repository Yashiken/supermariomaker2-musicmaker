$(document).ready(function () {
    ...
    let measures = [
        ...
        $("#measure2").offset().left - 140,
        $("#measure3").offset().left - 140,
        $("#measure4").offset().left - 140,
        $("#measure5").offset().left - 140,
        $("#measure6").offset().left - 140,
        $("#measure7").offset().left - 140,
        $("#measure8").offset().left - 140,
        $("#measure9").offset().left - 140,
        $("#measure10").offset().left - 140,
        $("#measure11").offset().left - 140,
        $("#measure12").offset().left - 140,
        $("#measure13").offset().left - 140 ,
        $("#measure14").offset().left - 140 ,//裏面
        $("#measure15").offset().left - 140,
        $("#measure16").offset().left - 140,
        $("#measure17").offset().left - 140,
        $("#measure18").offset().left - 140, 
        $("#measure19").offset().left - 140,
        $("#measure20").offset().left - 140,
        $("#measure21").offset().left - 140,
        $("#measure22").offset().left - 140,
        $("#measure23").offset().left - 140,
        $("#measure24").offset().left - 140,
        $("#measure25").offset().left - 140,
        $("#measure26").offset().left - 140
    ];
    let sorces = [
