$(document).ready(function () {
    ...
    let measures = [
        ...
        $("#measure2").offset().left - 170,
        $("#measure3").offset().left - 170,
        $("#measure4").offset().left - 170,
        $("#measure5").offset().left - 170,
        $("#measure6").offset().left - 170,
        $("#measure7").offset().left - 170,
        $("#measure8").offset().left - 170,
        $("#measure9").offset().left - 170,
        $("#measure10").offset().left - 170,
        $("#measure11").offset().left - 170,
        $("#measure12").offset().left - 170,
        $("#measure13").offset().left - 170,
        $("#measure14").offset().left - 170, //裏面
        $("#measure15").offset().left - 170,
        $("#measure16").offset().left - 170,
        $("#measure17").offset().left - 170,
        $("#measure18").offset().left - 170,
        $("#measure19").offset().left - 170,
        $("#measure20").offset().left - 170,
        $("#measure21").offset().left - 170,
        $("#measure22").offset().left - 170,
        $("#measure23").offset().left - 170,
        $("#measure24").offset().left - 170,
        $("#measure25").offset().left - 170,
        $("#measure26").offset().left - 170
    ];
    let sorces = [
